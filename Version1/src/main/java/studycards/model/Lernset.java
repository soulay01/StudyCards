 ...
 * Zum Beispiel: "Mathe Grundlagen" mit 20 Karten.
 */
public class Lernset {

    // ----- Felder -----
    private int id;                  // Die Datenbank-ID des Sets
    private String name;             // Der Name des Lernsets
    private List<Lernkarte> karten;  // Alle Karten in diesem Set
    ...
    public int getAnzahlKarten() {
        return karten.size(); // Grösse der Liste zurückgeben
    }

    /**
     * Gibt das Lernset als lesbaren Text aus.
     * Wird in der ListView angezeigt.
